...
export const defaultEmailPlannerConfig: EmailPlannerConfig = {
  minSampleSize: 5000,
  maxDurationDays: 28,
...
export function validateEmailExperiment(
  ...
  variants: Variant[],
  config = defaultEmailPlannerConfig,
): string[] {
  const errors: string[] = [];
