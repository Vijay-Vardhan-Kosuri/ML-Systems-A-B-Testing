/**
 * mobile_nav experiment analyzer for ML A/B testing platform.
...
export type MobileNavAnalyzerConfig = {
...
export const defaultMobileNavAnalyzerConfig: MobileNavAnalyzerConfig = {
  minSampleSize: 5000,
  maxDurationDays: 28,
...
export function validateMobileNavExperiment(
  ...
  variants: Variant[],
  config = defaultMobileNavAnalyzerConfig,
): string[] {
  const errors: string[] = [];
