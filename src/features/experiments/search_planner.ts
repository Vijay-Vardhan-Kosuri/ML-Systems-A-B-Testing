/**
 * search experiment planner for ML A/B testing platform.
...
export type SearchPlannerConfig = {
...
export const defaultSearchPlannerConfig: SearchPlannerConfig = {
  minSampleSize: 5000,
  maxDurationDays: 28,
...
export function validateSearchExperiment(
  ...
  variants: Variant[],
  config = defaultSearchPlannerConfig,
): string[] {
  const errors: string[] = [];
