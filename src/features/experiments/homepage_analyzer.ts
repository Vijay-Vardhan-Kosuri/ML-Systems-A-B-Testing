...
export const defaultHomepageAnalyzerConfig: HomepageAnalyzerConfig = {
  minSampleSize: 5000,
  maxDurationDays: 28,
...
export function validateHomepageExperiment(
  ...
  variants: Variant[],
  config = defaultHomepageAnalyzerConfig,
): string[] {
  const errors: string[] = [];
