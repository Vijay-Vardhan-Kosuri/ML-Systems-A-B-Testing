/**
 * mobile_nav experiment reporter for ML A/B testing platform.
...
export type MobileNavReporterConfig = {
...
export const defaultMobileNavReporterConfig: MobileNavReporterConfig = {
  minSampleSize: 5000,
  maxDurationDays: 28,
...
export function validateMobileNavExperiment(
  ...
  variants: Variant[],
  config = defaultMobileNavReporterConfig,
): string[] {
  const errors: string[] = [];
