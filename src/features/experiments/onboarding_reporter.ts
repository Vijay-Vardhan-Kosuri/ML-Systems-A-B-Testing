...
export const defaultOnboardingReporterConfig: OnboardingReporterConfig = {
  minSampleSize: 5000,
  maxDurationDays: 28,
...
export function validateOnboardingExperiment(
  ...
  variants: Variant[],
  config = defaultOnboardingReporterConfig,
): string[] {
  const errors: string[] = [];
