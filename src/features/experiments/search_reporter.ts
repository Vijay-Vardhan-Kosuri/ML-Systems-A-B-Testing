/**
 * search experiment reporter for ML A/B testing platform.
...
export type SearchReporterConfig = {
...
export const defaultSearchReporterConfig: SearchReporterConfig = {
  minSampleSize: 5000,
  maxDurationDays: 28,
...
export function validateSearchExperiment(
  ...
  variants: Variant[],
  config = defaultSearchReporterConfig,
): string[] {
  const errors: string[] = [];
