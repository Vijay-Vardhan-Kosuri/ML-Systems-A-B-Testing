/**
 * recommendations experiment planner for ML A/B testing platform.
...
export type RecommendationsPlannerConfig = {
...
export const defaultRecommendationsPlannerConfig: RecommendationsPlannerConfig = {
  minSampleSize: 5000,
  maxDurationDays: 28,
...
export function validateRecommendationsExperiment(
  ...
  variants: Variant[],
  config = defaultRecommendationsPlannerConfig,
): string[] {
  const errors: string[] = [];
