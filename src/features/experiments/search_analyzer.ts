/**
 * search experiment analyzer for ML A/B testing platform.
...
export type SearchAnalyzerConfig = {
...
export const defaultSearchAnalyzerConfig: SearchAnalyzerConfig = {
  minSampleSize: 5000,
  maxDurationDays: 28,
...
export function validateSearchExperiment(
  ...
  variants: Variant[],
  config = defaultSearchAnalyzerConfig,
): string[] {
  const errors: string[] = [];
