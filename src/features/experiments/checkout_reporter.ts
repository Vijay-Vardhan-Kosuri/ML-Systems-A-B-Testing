/**
 * checkout experiment reporter for ML A/B testing platform.
...
export type CheckoutReporterConfig = {
...
export const defaultCheckoutReporterConfig: CheckoutReporterConfig = {
  minSampleSize: 5000,
  maxDurationDays: 28,
...
export function validateCheckoutExperiment(
  ...
  variants: Variant[],
  config = defaultCheckoutReporterConfig,
): string[] {
  const errors: string[] = [];
