/**
 * mobile_nav experiment planner for ML A/B testing platform.
...
export type MobileNavPlannerConfig = {
...
export const defaultMobileNavPlannerConfig: MobileNavPlannerConfig = {
  minSampleSize: 5000,
  maxDurationDays: 28,
...
export function validateMobileNavExperiment(
  ...
  variants: Variant[],
  config = defaultMobileNavPlannerConfig,
): string[] {
  const errors: string[] = [];
