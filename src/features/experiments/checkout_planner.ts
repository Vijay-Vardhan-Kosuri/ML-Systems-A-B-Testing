/**
 * checkout experiment planner for ML A/B testing platform.
...
export type CheckoutPlannerConfig = {
...
export const defaultCheckoutPlannerConfig: CheckoutPlannerConfig = {
  minSampleSize: 5000,
  maxDurationDays: 28,
...
export function validateCheckoutExperiment(
  ...
  variants: Variant[],
  config = defaultCheckoutPlannerConfig,
): string[] {
  const errors: string[] = [];
