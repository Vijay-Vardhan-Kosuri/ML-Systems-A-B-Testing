...
export const defaultEmailReporterConfig: EmailReporterConfig = {
  minSampleSize: 5000,
  maxDurationDays: 28,
...
export function validateEmailExperiment(
  ...
  variants: Variant[],
  config = defaultEmailReporterConfig,
): string[] {
  const errors: string[] = [];
