...
export const defaultPricingAnalyzerConfig: PricingAnalyzerConfig = {
  minSampleSize: 5000,
  maxDurationDays: 28,
...
export function validatePricingExperiment(
  ...
  variants: Variant[],
  config = defaultPricingAnalyzerConfig,
): string[] {
  const errors: string[] = [];
