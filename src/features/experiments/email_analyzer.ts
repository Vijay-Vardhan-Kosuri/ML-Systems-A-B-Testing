...
export const defaultEmailAnalyzerConfig: EmailAnalyzerConfig = {
  minSampleSize: 5000,
  maxDurationDays: 28,
...
export function validateEmailExperiment(
  ...
  variants: Variant[],
  config = defaultEmailAnalyzerConfig,
): string[] {
  const errors: string[] = [];
