...
export const defaultPaywallReporterConfig: PaywallReporterConfig = {
  minSampleSize: 5000,
  maxDurationDays: 28,
...
export function validatePaywallExperiment(
  ...
  variants: Variant[],
  config = defaultPaywallReporterConfig,
): string[] {
  const errors: string[] = [];
