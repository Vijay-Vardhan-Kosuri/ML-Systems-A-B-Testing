/**
 * recommendations experiment reporter for ML A/B testing platform.
...
export type RecommendationsReporterConfig = {
...
export const defaultRecommendationsReporterConfig: RecommendationsReporterConfig = {
  minSampleSize: 5000,
  maxDurationDays: 28,
...
export function validateRecommendationsExperiment(
  ...
  variants: Variant[],
  config = defaultRecommendationsReporterConfig,
): string[] {
  const errors: string[] = [];
