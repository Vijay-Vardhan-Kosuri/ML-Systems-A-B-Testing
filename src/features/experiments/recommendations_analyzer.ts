/**
 * recommendations experiment analyzer for ML A/B testing platform.
...
export type RecommendationsAnalyzerConfig = {
...
export const defaultRecommendationsAnalyzerConfig: RecommendationsAnalyzerConfig = {
  minSampleSize: 5000,
  maxDurationDays: 28,
...
export function validateRecommendationsExperiment(
  ...
  variants: Variant[],
  config = defaultRecommendationsAnalyzerConfig,
): string[] {
  const errors: string[] = [];
