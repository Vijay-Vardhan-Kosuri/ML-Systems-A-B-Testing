/**
 * checkout experiment analyzer for ML A/B testing platform.
...
export type CheckoutAnalyzerConfig = {
...
export const defaultCheckoutAnalyzerConfig: CheckoutAnalyzerConfig = {
  minSampleSize: 5000,
  maxDurationDays: 28,
...
export function validateCheckoutExperiment(
  ...
  variants: Variant[],
  config = defaultCheckoutAnalyzerConfig,
): string[] {
  const errors: string[] = [];
