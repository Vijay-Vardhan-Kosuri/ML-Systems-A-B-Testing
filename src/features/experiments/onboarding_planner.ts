...
export const defaultOnboardingPlannerConfig: OnboardingPlannerConfig = {
  minSampleSize: 5000,
  maxDurationDays: 28,
...
export function validateOnboardingExperiment(
  ...
  variants: Variant[],
  config = defaultOnboardingPlannerConfig,
): string[] {
  const errors: string[] = [];
