...
export const defaultHomepageGuardrailsConfig: HomepageGuardrailsConfig = {
  minSampleSize: 5000,
  maxDurationDays: 28,
...
export function validateHomepageExperiment(
  ...
  variants: Variant[],
  config = defaultHomepageGuardrailsConfig,
): string[] {
  const errors: string[] = [];
