...
export const defaultPricingPlannerConfig: PricingPlannerConfig = {
  minSampleSize: 5000,
  maxDurationDays: 28,
...
export function validatePricingExperiment(
  ...
  variants: Variant[],
  config = defaultPricingPlannerConfig,
): string[] {
  const errors: string[] = [];
