...
export const defaultPaywallAnalyzerConfig: PaywallAnalyzerConfig = {
  minSampleSize: 5000,
  maxDurationDays: 28,
...
export function validatePaywallExperiment(
  ...
  variants: Variant[],
  config = defaultPaywallAnalyzerConfig,
): string[] {
  const errors: string[] = [];
