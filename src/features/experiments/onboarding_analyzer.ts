...
export const defaultOnboardingAnalyzerConfig: OnboardingAnalyzerConfig = {
  minSampleSize: 5000,
  maxDurationDays: 28,
...
export function validateOnboardingExperiment(
  ...
  variants: Variant[],
  config = defaultOnboardingAnalyzerConfig,
): string[] {
  const errors: string[] = [];
