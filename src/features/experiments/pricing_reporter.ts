...
export const defaultPricingReporterConfig: PricingReporterConfig = {
  minSampleSize: 5000,
  maxDurationDays: 28,
...
export function validatePricingExperiment(
  ...
  variants: Variant[],
  config = defaultPricingReporterConfig,
): string[] {
  const errors: string[] = [];
