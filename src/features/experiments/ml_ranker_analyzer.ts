...
export const defaultMlRankerAnalyzerConfig: MlRankerAnalyzerConfig = {
  minSampleSize: 5000,
  maxDurationDays: 28,
  primaryMetric: "ndcg",
...
export function validateMlRankerExperiment(
  ...
  variants: Variant[],
  config = defaultMlRankerAnalyzerConfig,
): string[] {
  const errors: string[] = [];
