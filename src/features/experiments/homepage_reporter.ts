...
export const defaultHomepageReporterConfig: HomepageReporterConfig = {
  minSampleSize: 5000,
  maxDurationDays: 28,
...
export function validateHomepageExperiment(
  ...
  variants: Variant[],
  config = defaultHomepageReporterConfig,
): string[] {
  const errors: string[] = [];
