...
export const defaultPaywallGuardrailsConfig: PaywallGuardrailsConfig = {
  minSampleSize: 5000,
  maxDurationDays: 28,
...
export function validatePaywallExperiment(
  ...
  variants: Variant[],
  config = defaultPaywallGuardrailsConfig,
): string[] {
  const errors: string[] = [];
