...
export const defaultMlRankerReporterConfig: MlRankerReporterConfig = {
  minSampleSize: 5000,
  maxDurationDays: 28,
  primaryMetric: "ndcg",
...
export function validateMlRankerExperiment(
  ...
  variants: Variant[],
  config = defaultMlRankerReporterConfig,
): string[] {
  const errors: string[] = [];
